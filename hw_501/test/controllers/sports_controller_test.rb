...
class SportsControllerTest < ActionController::TestCase
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post :create, sport: { favorite_player: @sport.favorite_player, favorite_team: @sport.favorite_team, why: @sport.why }
    end
  ...
  test "should update sport" do
    patch :update, id: @sport, sport: { favorite_player: @sport.favorite_player, favorite_team: @sport.favorite_team, why: @sport.why }
    assert_redirected_to sport_path(assigns(:sport))
  end
